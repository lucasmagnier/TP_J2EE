...
<html>
    ...
    if (pays == null) {
    %>
    <FORM  action="http://localhost:8080/TP_TAG_LIB/JSPMultiLanguageYellowJacket?lang=fr" method="post">
	...
	case "france":
		...
		out.println("<FORM  action=\"http://localhost:8080/TP_TAG_LIB/JSPMultiLanguageYellowJacket?lang=fr\" method=\"post\">");
